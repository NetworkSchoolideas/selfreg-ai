...
| P1-02 | P1 | The first student screen selects GitHub Models while no key is present, making a usable no-key flow look unavailable. | Confirmed locally | Evaluate a low-friction default after the clarification fix. |
...
The next candidate is P1-02: assess a low-friction provider default without changing the fixed five-stage learning logic.
