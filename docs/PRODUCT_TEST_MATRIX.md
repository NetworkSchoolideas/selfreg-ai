...
| P2-04 | P2 | Teacher dashboard leads with database/technical framing rather than an observation-to-conversation workflow. | Discovery complete | Implement only the documented read-only hierarchy after comparative manual QA. |
...
The next candidate is P2-04 implementation: introduce the documented read-only observation-to-conversation hierarchy after comparative manual QA.
