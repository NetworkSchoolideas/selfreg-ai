...
The next candidate is P3-05 reproduction: check whether the teacher language transition can still flash the previous language in a production-build navigation.
