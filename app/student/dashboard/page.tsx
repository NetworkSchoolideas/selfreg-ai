...
function StudentDashboardContent() {
  ...
  const ui = {
    ru: {
      ...
      hideSessionTitle: "Скрыть из моего кабинета",
      hideSessionMessage: "Сессия исчезнет из вашего списка, но останется доступна педагогу.",
      hideSessionConfirm: "Скрыть из моего кабинета",
      cancel: "Отмена",
      home: "На главную",
